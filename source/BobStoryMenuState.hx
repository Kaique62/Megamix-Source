...
class BobStoryMenuState extends MusicBeatState
{
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			if (curWeek == 1) {
				...
				{
					LoadingState.loadAndSwitchState(new VideoState('assets/videos/ronPreCutscene/ronPreCutscene.webm', new PlayState()), true);
				});
			}
